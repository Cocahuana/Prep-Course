...
function sumarLikesDeUsuario(usuario) {
  ...
  // Devuelve la suma
  // Tu código:
  //var sumaLikes = usuario.posts.post.likes;
  var resultado = 0;
  for (const POST in usuario.posts){
    resultado =  resultado + usuario.posts[POST].likes; 
  }
  return resultado;
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  /* Otra forma de hacerlo (es mas facil de leer usando this ya que hace referencia a producto)
  producto.calcularPrecioDescuento = function() {
